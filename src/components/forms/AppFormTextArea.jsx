...
const AppFormTextArea = ({
  ...
  return (
    <div className={containerClassName}>
      <label
        htmlFor={id}
        className="focus:text-dark-blue text-dark text-sm lg:text-base mb-1 ml-1 focus-within:text-dark-blue"
      >
        {label}
      </label>
      <div
        className={`w-full test-sm lg:text-base h-24 border-[1px] border-gray-400 rounded-lg flex text-dark focus-within:border-dark-blue/60 ${className} ${
