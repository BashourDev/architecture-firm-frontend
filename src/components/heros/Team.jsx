        ...
        <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                <h3>Carl Jones</h3>
                <p className="text-dark-gold">CTO and Co-Founder</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                ...
                <p className="text-dark-gold">Marketing Directory</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                <h3>Tommy Barnes</h3>
                <p className="text-dark-gold">Designer</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                <h3>Ron Jenson</h3>
                <p className="text-dark-gold">Architect</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                ...
                <p className="text-dark-gold">Sales Manager</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            ...
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                <h3>Alexis Jordan</h3>
                <p className="text-dark-gold">Affiliate Manager</p>
              </div>
              {/* <div className="relative flex items-center justify-center space-x-3">
                <a href="#_" className="text-gray-300 hover:text-gray-400">
                  <svg
